...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const countryLangMap = {
    ...
    NG: 'en', CO: 'es', PE: 'es', CL: 'es', AR: 'es', MX: 'es',
    CR: 'es', HN: 'es', DO: 'es', GT: 'es', PA: 'es', EC: 'es',
    VE: 'es', BO: 'es', PY: 'es', BR: 'pt', CA: 'fr', US: 'en',
    GB: 'en', AU: 'en', NZ: 'en', IE: 'en', SG: 'en', HK: 'zh',
    TW: 'zh', KH: 'km', LA: 'lo', MN: 'mn', IS: 'is', DK: 'da',
    BG: 'bg', SK: 'sk', LT: 'lt', LV: 'lv', EE: 'et', BY: 'be',
    MK: 'mk', RS: 'sr', BA: 'bs', ME: 'sr', HR: 'hr', SI: 'sl',
    GE: 'ka', AM: 'hy', AZ: 'az', TJ: 'tg', KY: 'ky', TG: 'tg',
    NE: 'ne', KG: 'ky', MZ: 'pt', ZM: 'en', ZW: 'en'
  };
